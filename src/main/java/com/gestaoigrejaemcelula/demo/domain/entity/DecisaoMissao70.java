...
@Entity
@Table(name = "decisoes_missao70")
public class DecisaoMissao70 {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "encontro_missao70_id", nullable = false)
    @JsonIgnoreProperties({"decisoes", "missao70", "hibernateLazyInitializer"})
    private EncontroMissao70 encontro;
    ...
    public EncontroMissao70 getEncontro() { return encontro; }
    public void setEncontro(EncontroMissao70 encontro) { this.encontro = encontro; }
}