...
@Entity
@Table(name = "lancamento_tesouraria", indexes = {
    @Index(name = "idx_lancamento_data", columnList = "dataLancamento"),
    @Index(name = "idx_lancamento_membro_nome", columnList = "membroNome")
})
