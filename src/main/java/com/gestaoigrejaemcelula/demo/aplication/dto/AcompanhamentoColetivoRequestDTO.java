...
@Data
public class AcompanhamentoColetivoRequestDTO {

    @NotNull(message = "Data do encontro é obrigatória")
    @PastOrPresent(message = "Data do encontro não pode ser futura")
    private LocalDate data;

    @NotNull(message = "Horário do encontro é obrigatório")
    ...
    @NotNull(message = "Informe os membros presentes")
